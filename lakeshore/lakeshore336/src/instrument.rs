...
impl<'d, I: Read + Write> Lakeshore336Output<'d, I> {
    ...
    ///
    /// Heater output in percent (between 0.0 and 1.0). This command is for the heater
    /// outputs Out1 and Out2 only. For outputs Out3 and Out4, use `get_heater_analog_output`.
    pub fn get_heater_output(&mut self) -> Result<f64, InstrumentRsError> {
        // TODO: Define some percentage type in instrumentrs for floats
        todo!()
    }
